...
var items = [
    { name: 'P 1.0', code: 'green' }, { name: 'P 1.1', code: 'green' },
    { name: 'P 1.2', code: 'green' }, { name: 'P 1.3', code: 'green' },
    { name: 'P 1.4', code: 'green' }, { name: 'P 1.5', code: 'green' },
    { name: 'P 1.6', code: 'green' }, { name: 'P 1.7', code: 'green' },
    { name: 'P 1.8', code: 'green' }, { name: 'P 1.9', code: 'green' },
    { name: 'P 1.10', code: 'green' }, { name: 'P 1.11', code: 'green' },
    { name: 'P 1.12', code: 'green' }, { name: 'P 1.13', code: 'green' },
    { name: 'P 1.14', code: 'green' }, { name: 'P 1.15', code: 'green' },
    { name: 'P 1.16', code: 'green' }, { name: 'P 1.17', code: 'green' },
    { name: 'P 1.18', code: 'green' }, { name: 'P 1.19', code: 'green' },
];
...
import React, { Component } from 'react';
import PropTypes from 'prop-types';
import { Text, View, ListView, Dimensions, ViewPropTypes, StyleSheet, TouchableOpacity, Button } from 'react-native';
...
export default class GridViewExample extends Component {
        ...
        headerRight:
            <View style={styles.app}>
                <PopoverTouchable onPopoverDisplayed={() => console.log('Popover displayed!')}>
                    <Button title="Tang 1" onPress={() =>{ console.log('I don\'t work');
                        isShow = true;
                    }}/>
                    <Popover
                    ...
                    >
                        ...
                        <Text>Hello from inside popover!</Text>
                        <Text>Hello from inside popover!</Text>
                        <Text onPress={() => {isShow = false; console.log('I don\'t work');}
                        }>Hello from inside popover!</Text>
                        <Text onPress={() => {isShow = false; console.log('I don\'t work');}
                        }>Hello from inside popover!</Text>
                        <Text onPress={() => {isShow = false; console.log('I don\'t work');}
                        }>Hello from inside popover!</Text>
    ...
    _onPressRow(rowId,colum) {
        ...
        newDs[((parseInt(rowId) * 2) + parseInt(colum))].code = 'red'
